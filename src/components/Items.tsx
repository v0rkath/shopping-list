...
export default function Items(props: {name: string, move: Function}) {
    ...
    return (
        <div className={`rounded-3xl bg-sage ${marked ? "bg-neutral-100" : "bg-sage"} p-4 text-left md:inline-flex flex flex-col justify-around mr-4 cursor-pointer mb-4 text-left`} onClick={handleClick}>
