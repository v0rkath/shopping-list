...
export default function CreateLinkForm() {
    ...
    return (
        <form className='flex flex-col md:max-w-sm max-w-96 mx-auto' onSubmit={generateLink}>
            ...
            <input type="text" id="name" name="name" placeholder="e.g. Family List" value={data.name || ""} onChange={handleChange} className='rounded-md h-11 bg-white border-zinc-300 border px-4'/>
